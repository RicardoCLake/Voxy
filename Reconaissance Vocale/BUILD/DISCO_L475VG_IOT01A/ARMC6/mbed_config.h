...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                   "@Projet!iot2024!"                                                                               // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                   WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                       "fabrique2024"                                                                                   // set by application[*]
